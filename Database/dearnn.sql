...
-- Database: `dearnn`
--
CREATE DATABASE IF NOT EXISTS `dearnn` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dearnn`;
...
(1, 'Arun', 'Arun1232@gmail.com', 'Arun', '9535866270', 'India', 'Karnataka', 'Bangalore', '#782,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_cyberbullying_detection_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_cyberbullying_detection_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_cyberbullying_detection_type`
--

INSERT INTO `remote_user_cyberbullying_detection_type` (`id`, `Tweet_Message`, `Prediction`) VALUES
(1, 'Karma. I hope it bites Kat on the butt. She is just nasty. #mkr', 'gender'),
(2, 'Karma. I hope it bites Kat on the butt. She is just nasty. #mkr', 'gender'),
(3, 'even alle bully beatdown afleveringen gedownload van season 1 en 2 :)', 'not_cyberbullying'),
(4, 'Iâ€™m sick of people still making jokes about rape and using â€˜gayâ€™ as an insult. Just stop it.', 'gender'),
(5, 'the right thing to do? I as a Christian woman and a Southern Baptist, strongly demand that you tell the truth. Take responsibility. You have already lost millions of dollars ', 'religion'),
(6, 'RT @RiotFest: This is fucking terrible. People have no respect anymore. https://t.co/GHPyGPnidl', 'other_cyberbullying'),
(7, 'know them niggas lookin so you know they gon hate Ã°ÂŸÂ˜Âˆ', 'ethnicity'),
(8, '@UmarFarooq_ radial momentum means that it does not fly away.  In the same way, both the plane and the atmosphere have radial momentum.', 'not_cyberbullying');
